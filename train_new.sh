...
# Finetune Unitree G1 hangzhou joint-space datasets (no SMPL / rot6d root processing).
# Embodiment: examples/G1/unitree_g1_new — state 31D, action 35D (29dof + gripper + base_cmd).

PROJECT_ROOT="/sh/ycb/model/GR00T"
VENV_PATH="/sh/ycb/venvs/gr00t_n1d7/bin/activate"
CACHE_ROOT="/sh/ycb/.cache"
DATASET_ROOT="/sh/datasets/g1/hangzhou/arrange_flowers"
EXP_NAME="GR00T_N1d7_100k_g1_new_arrange_flowers"
...
EMBODIMENT_TAG="UNITREE_G1_NEW"
MODALITY_CONFIG_PATH="examples/G1/unitree_g1_new/unitree_g1_new_config.py"
...
WANDB_PROJECT="GR00T_N1d7_100k_g1_new_arrange_flowers"

# Init
RESUME_FROM_CHECKPOINT="${RESUME_FROM_CHECKPOINT:-0}"
# Resume
# export WANDB_RUN_ID=xxxxxxxx
...
echo "root-process-mode=original (no rot6d / euler)"
echo "Extra CLI args: $*"
